...
require([], function() {
    ...
    material.map = THREE.ImageUtils.loadTexture('img/galaxies.jpg')
    ...
    materialStars.map = THREE.ImageUtils.loadTexture('img/stars-transparent.png')
    ...
    materialSol.map = THREE.ImageUtils.loadTexture('img/preview_sun.jpg');
    ...
    imageMap.addEventListener("load", function() {
        ...
        imageTrans.src = 'img/earthcloudmap.jpg';
    }, false);
    imageMap.src = 'img/earthcloudmap1.jpg';
    ...
    //Mercurio
    var geometriaMerc = new THREE.SphereGeometry(0.0003261, 32, 32);
    var materialMerc = new THREE.MeshPhongMaterial();
    var meshMerc = new THREE.Mesh(geometriaMerc, materialMerc);
    materialMerc.map = THREE.ImageUtils.loadTexture('img/mercurymap.jpg');
    materialMerc.bumpMap = THREE.ImageUtils.loadTexture('img/mercurymap.jpg');
    ...
    materialVenus.map = THREE.ImageUtils.loadTexture('img/venusmap.jpg');
    materialVenus.bumpMap = THREE.ImageUtils.loadTexture('img/venusbump.jpg');
    ...
    materialMarte.map = THREE.ImageUtils.loadTexture('img/mars_1k_color.jpg');
    materialMarte.bumpMap = THREE.ImageUtils.loadTexture('img/mars_1k_topo.jpg');
    ...
    materialJupiter.map = THREE.ImageUtils.loadTexture('img/jupitermap.jpg');
    ...
    materialSaturno.map = THREE.ImageUtils.loadTexture('img/saturnmap.jpg');
    ...
    materialAnillo.map = THREE.ImageUtils.loadTexture('img/saturnoanillo.png ');
    ...
    materialUrano.map = THREE.ImageUtils.loadTexture('img/uranus.jpg');
    ...
    materialAnilloUrano.map = THREE.ImageUtils.loadTexture('img/uranoanillo.png');
    ...
    materialNeptuno.map = THREE.ImageUtils.loadTexture('img/neptunemap.jpg');
